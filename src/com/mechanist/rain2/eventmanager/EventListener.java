...
public class EventListener implements KeyListener, MouseListener {
    ...
    public boolean[] mouseButtons1 = new boolean[10];
    public int mouseX = 0;
    public int mouseY = 0;
    ...
    public void mouseClicked(MouseEvent e) {
        mouseButtons1[e.getButton()] = !mouseButtons1[e.getButton()];
    }
